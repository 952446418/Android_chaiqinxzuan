...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String ITEM_MedicineName = "MedicineName";
    public static final String ITEM_TotalNumber = "TotalNumber";
    public static final String ITEM_Value = "Value";
    public static final String ITEM_Min = "Min";

    public static final String TABLE_NAME2 = "history";
    public static final String HISTORY_ID2 = "id";
    public static final String HISTORY_CustomerName = "CustomerName";
    public static final String HISTORY_Phonenumber = "Phonenumber";
    public static final String HISTORY_Other = "Other";
    public static final String HISTORY_Sale = "Sale";
